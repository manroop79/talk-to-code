            ...
            >
              ...
              <div className="flex flex-col items-center text-center p-8">
                ...
                <motion.h3
                  ...
                  className="font-bold text-2xl text-neutral-700 dark:text-neutral-200 mb-3"
                >
                  {active.title}
                </motion.h3>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="text-neutral-600 text-sm md:text-base mb-6 max-h-60 overflow-auto dark:text-neutral-400 [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                >
                ...
                <motion.button
                  ...
                  className="px-6 py-3 text-sm rounded-full font-bold bg-green-500 hover:bg-green-600 text-white cursor-pointer transition"
